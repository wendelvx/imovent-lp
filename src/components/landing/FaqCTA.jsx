...
import { ChevronDown, ArrowRight, Zap, ShieldCheck, Clock, MessageCircle } from 'lucide-react';
...
export default function FaqCTA() {
  ...
  const faqs = [
    { 
      ...
      a: "O Imovent é completo: ele une CRM, site e WhatsApp em um só lugar. Se você já tem um CRM, ele pode atuar como um acelerador para sua captação. Mas se quiser simplificar e reduzir custos, ele tem tudo para ser a única ferramenta aberta no seu computador para gerenciar 100% das suas vendas." 
    },
    { 
      q: "Como o site próprio ajuda a aumentar meu lucro?", 
      a: "Nos portais, você aluga espaço e divide a atenção do cliente com dezenas de outros corretores. Ter seu próprio site otimizado para o Google significa construir sua marca. O cliente pesquisa, acha você, e o contato vai direto para o seu WhatsApp, sem leilão e sem dividir comissão." 
    },
    { 
      q: "É muito difícil de configurar? Vai tomar meu tempo?", 
      a: "De jeito nenhum. O sistema já vem pronto para o uso prático. O processo de criar sua conta e colocar seu site no ar leva cerca de 2 minutos. E não se preocupe com curva de aprendizado: desenhamos a plataforma para ser tão fácil de usar quanto o próprio WhatsApp." 
    },
    { 
      q: "O teste gratuito me dá acesso a tudo?", 
      a: "Sim. Durante o período de teste, você recebe acesso à plataforma completa para testar de verdade: CRM, automações e criação do site. Acreditamos que você precisa sentir o alívio na sua rotina e ver o sistema funcionando antes de decidir assinar." 
    }
  ];
  ...
  return (
    <section className="bg-white py-32 px-6 lg:px-12 relative border-b-2 border-slate-900">
      ...
      {/* FAQ Section: Respostas Claras e Amigáveis */}
      <div className="max-w-3xl mx-auto mb-32">
        ...
        >
          <div className="inline-flex items-center justify-center gap-2 mb-6">
             ...
             <span className="text-[11px] font-black text-indigo-700 uppercase tracking-[0.2em] bg-indigo-50 border border-indigo-200 px-3 py-1">Ficou alguma dúvida?</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-950 mb-4 tracking-tighter leading-[1.1]">
            Tudo o que você precisa saber antes de <span className="text-indigo-600">começar.</span>
          </h2>
        </motion.div>
      ...
      {/* Mega-Bloco CTA Final: O Convite Final Seguro e Acolhedor */}
      <div className="max-w-5xl mx-auto">
        <motion.div 
          initial={{ opacity: 0, y: 40 }} 
          whileInView={{ opacity: 1, y: 0 }} 
          viewport={{ once: true }}
          className="bg-[#0B0F19] bg-dotted-pattern border-2 border-slate-900 p-10 md:p-20 text-center shadow-solid-dark relative overflow-hidden rounded-3xl"
        >
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-5 py-2 bg-emerald-500 border-2 border-emerald-900 text-slate-950 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-10 transform -rotate-1">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.2em]">Configuração Rápida</span>
            </div>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-[4rem] font-extrabold text-white mb-8 tracking-tighter leading-[1.05] max-w-4xl mx-auto">
              Sua rotina de vendas <span className="text-indigo-500">organizada</span> a partir de hoje.
            </h2>
            
            <p className="text-lg text-slate-400 font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
              Chega de perder tempo caçando informações no WhatsApp ou brigando com planilhas. Centralize tudo em um só lugar e tenha paz para focar no que realmente importa: fechar negócios.
            </p>
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 text-[11px] font-black text-slate-500 uppercase tracking-widest bg-slate-900/50 px-6 py-3 border border-slate-800 rounded-xl">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-emerald-500" /> Controle Total
                </div>
                <div className="hidden md:block w-1 h-1 bg-slate-700 rounded-full"></div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-indigo-400" /> Pronto em 2 minutos
                </div>
              </div>
            </div>
          </div>
